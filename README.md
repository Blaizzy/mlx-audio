...
| **MiMo-V2.5-ASR** | Xiaomi's speech recognition model | ZH, EN | [mlx-community/MiMo-V2.5-ASR-MLX](https://huggingface.co/mlx-community/MiMo-V2.5-ASR-MLX) |
...
See the [MiMo-V2.5-ASR README](mlx_audio/stt/models/mimo_v2_asr/README.md) for local-path loading and tokenizer override examples.
