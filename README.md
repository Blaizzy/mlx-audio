...
For architecture details and runtime contracts, see [`TECHNICAL_OVERVIEW.md`](mlx_audio/tts/models/moss_tts/TECHNICAL_OVERVIEW.md) and [`moss_tts_realtime/TECHNICAL_OVERVIEW.md`](mlx_audio/tts/models/moss_tts_realtime/TECHNICAL_OVERVIEW.md).
