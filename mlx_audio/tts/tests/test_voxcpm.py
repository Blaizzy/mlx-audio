...
class TestVoxCPM(unittest.TestCase):
    ...
    def test_sanitize_weight_norm(self):
        ...
        weights = {
            "encoder.conv_in.weight_g": g,
            "encoder.conv_in.weight_v": v
        }
    ...
    def test_model_init(self):
        ...
        from mlx_audio.tts.models.voxcpm.config import LMConfig, EncoderConfig, DiTConfig, AudioVAEConfig
        ...
        args = ModelArgs(
            ...
            dit_config=DiTConfig(
                num_layers=1, 
                hidden_dim=64,
                cfm_config={"solver": "euler"} # Dict will be converted by from_dict or need explicit obje? 
            ...
            audio_vae_config=AudioVAEConfig(encoder_rates=[2], decoder_rates=[2], encoder_dim=16, decoder_dim=16, latent_dim=16),
            patch_size=2,
            feat_dim=16
        )
