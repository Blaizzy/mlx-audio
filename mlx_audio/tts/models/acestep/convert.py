...
sys.path.insert(0, '/Users/mm725821/code/canary-conversion/mlx-audio-firered')

def convert_acestep(model_repo, output_dir):
    ...
    local_dir = "/Users/mm725821/.cache/modelscope/hub/models/ACE-Step/Ace-Step1.5/acestep-v15-turbo"
    print("Loading raw state dict to bypass PyTorch bugs...")
    state_dict = safetensors.torch.load_file(os.path.join(local_dir, "model.safetensors"))
    ...
    silence_path = os.path.join(local_dir, "silence_latent.pt")
...
convert_acestep("ACE-Step/Ace-Step1.5", "/tmp/acestep-mlx-converted")
