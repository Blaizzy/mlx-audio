...
| [**Qwen3-ASR**](qwen3-asr.md) | Alibaba | 0.6B / 1.7B | ZH, EN, JA, KO + more | Yes | Segment | [mlx-community/Qwen3-ASR-1.7B-8bit](https://huggingface.co/mlx-community/Qwen3-ASR-1.7B-8bit) |
| [**Confucius4-R2T2**](qwen3-asr.md) | NetEase Youdao | Qwen3-ASR-1.7B backbone | ZH, EN, RU + more | Live input | -- | [netease-youdao/Confucius4-R2T2](https://huggingface.co/netease-youdao/Confucius4-R2T2) |
