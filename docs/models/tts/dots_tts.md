...
Dots TTS is a multilingual voice-cloning model ported to MLX for Apple Silicon. The current `mlx-audio` integration supports local converted checkpoints in the repo's `dots` layout and has been verified on the `mlx-community/dots-tts-mlx` checkpoints.

## Model Variants

| Model | Notes | HuggingFace |
|-------|-------|-------------|
| `mlx-community/dots-tts-mlx` `int4` | Verified in `mlx-audio`; 48 kHz output | [:octicons-link-external-16: Model Card](https://huggingface.co/mlx-community/dots-tts-mlx) |
| `mlx-community/dots-tts-mlx` `int8` | Same layout, larger footprint | [:octicons-link-external-16: Model Card](https://huggingface.co/mlx-community/dots-tts-mlx) |
| `mlx-community/dots-tts-mlx` `mf-int4` / `mf-int8` | Meanflow variants | [:octicons-link-external-16: Model Card](https://huggingface.co/mlx-community/dots-tts-mlx) |
...
- [:octicons-link-external-16: mlx-community/dots-tts-mlx](https://huggingface.co/mlx-community/dots-tts-mlx)
